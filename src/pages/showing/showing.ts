...
export class ShowingPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams) {
    this.movies=[
      ...
      {nameTh:"บันทึกทางไกล...ถึงพ่อ",nameEn:"The Journey",Date:"12-10-2017",Type:"DOCUMENTARY",Rate:"ทั่วไป",
      minutes:"61",Directed:"มนัสนันท์ พันเลิศวงศ์สกุล",Starring:[],
      plot:"ภาพยนตร์สารคดี บันทึกทางไกล...ถึงพ่อ (The Journey) รวบรวมการเดินทางของในหลวงรัชกาลที่ ๙ ในปีพุทธศักราช ๒๔๗๖ ถึง ๒๔๙๔ ผ่านพระราชหัตถเลขา และไปรษณียบัตร รวมถึงภาพถ่ายฝีพระหัตถ์ วีดิทัศน์พระราชทานสัมภาษณ์ และการสัมภาษณ์บุคคลสำคัญที่เคยถวายงานพระองค์ บอกเล่าเรื่องราวเมื่อครั้งเสด็จประทับ ณ เมืองโลซาน ประเทศสวิตเซอร์แลนด์ เพื่อทรงศึกษาต่อและความสนพระราชหฤทัยในศิลปะดนตรีและการถ่ายภาพ รวมถึงช่วงเวลาที่พระองค์ทรงพบสมเด็จพระนางเจ้าสิริกิติ์ พระบรมราชินีนาถ เป็นครั้งแรกที่ Fontainebleau ชานกรุงปารีส สาธารณรัฐฝรั่งเศส จวบจนกระทั่ง ทั้งสองพระองค์เสด็จนิวัติประเทศไทย โดยบันทึกการเดินทางไกลของพระบาทสมเด็จพระปรมินทรมหาภูมิพลอดุลยเดช บรมนาถบพิตร จะได้รับการร้อยเรียงให้พสกนิกรชาวไทยเข้าใจว่าสิ่งใดที่หล่อหลอมให้พระองค์เป็นพระมหากษัตริย์ผู้ทรงเป็นที่รัก และสถิตในดวงใจของประชาชนชาวไทยตราบเท่าทุกวันนี้"
      },
